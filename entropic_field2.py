...
class GridVoice:
    def __init__(self, voice_idx):
        ...
        self.rev_bl = Freeverb(self.ch_bl + self.dly_bl, size=0.65, damp=0.5, bal=rev_port, mul=comp_port).out(2 % num_channels)
        self.rev_br = Freeverb(self.ch_br + self.dly_br, size=0.75, damp=0.5, bal=rev_port, mul=comp_port).out(3 % num_channels)
